/*
  ...
  - You are about to alter the column `hourEnd` on the `Ad` table. The data in that column could be lost. The data in that column will be cast from `String` to `DateTime`.
